    ...
    >
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <motion.h1 
            className={`text-4xl md:text-5xl font-bold ${props.mode === 'light' ? 'text-black' : 'text-white'}`}
          ...
          <p className={`${props.mode === 'light' ? 'text-black' : 'text-white'} mt-4`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h3 className={`text-lg font-semibold ${props.mode === 'light' ? 'text-black' : 'text-white'}`}>Email</h3>
                <p className={`${props.mode === 'light' ? 'text-black' : 'text-white'}`}>contact@example.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h3 className={`text-lg font-semibold ${props.mode === 'light' ? 'text-black' : 'text-white'}`}>Call</h3>
                <p className={`${props.mode === 'light' ? 'text-black' : 'text-white'}`}>+1 (123) 456-7890</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h3 className={`text-lg font-semibold ${props.mode === 'light' ? 'text-black' : 'text-white'}`}>Visit</h3>
                <p className={`${props.mode === 'light' ? 'text-black' : 'text-white'}`}>1234 Main Street, Anytown, USA</p>
              </div>
            </div>
